...
// Deal Of The Day
    ...
    Route::group(['middleware' => 'permissions:home_page_settings'], function () {
        ...
        Route::get('bottom/banner/', 'Admin\BannerController@large')->name('admin-sb-large');
        Route::get('bottom/banner/create', 'Admin\BannerController@largecreate')->name('admin-sb-create-large');
        Route::get('/banner', 'Admin\BannerController@index')->name('admin-sb-index');
        Route::get('/banner/create', 'Admin\BannerController@create')->name('admin-sb-create');
...
// -------------------- Reward Section Route ---------------------//
    ...
    Route::group(['middleware' => 'permissions:subscribers'], function () {
        ...
        Route::delete('/subscriber/delete/{id}', 'Admin\SubscriberController@delete')->name('admin-subs-delete');
...
// ************************************ USER SECTION **********************************************
    ...
    Route::prefix('user')->group(function () {
        ...
        Route::get('admin/user/send/message', 'User\MessageController@adminusercontact')->name('user-send-message');
...
Route::get('user/conversation/{id}', 'Front\ChatController@convo')->name('chat.conversation');
Route::post('user/send_message/{id}', 'Front\ChatController@send_message')->name('chat.send_message');
