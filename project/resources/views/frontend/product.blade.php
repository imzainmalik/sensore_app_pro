...
@section('content')
                                                ...
                                                <div class="product-wrapper">
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <div class="product-price">
                                                            ...
                                                            <div class="on-sale">
                                                                <span>{{ round($prod->offPercentage()) }}</span><span>%
                                                                    off</span></div>
                                                        </div>
                ...
                <div class="col-12">
                    <div class="products product-style-1 owl-mx-5">
                        <div
                            ...
                            @foreach (App\Models\Product::where('type', $productt->type)->where('product_type', $productt->product_type)->withCount('ratings')->withAvg('ratings', 'rating')->take(12)->get() as $item)
                                <div class="item">
                                    <div class="product type-product">
                                        <div class="product-wrapper">
                                            <div class="product-image">
                                            ...
                                            <div class="product-info">
                                                <h3 class="product-title"><a
                                                        href="{{ route('front.product', $item->slug) }}">{{ $item->showName() }}</a>
                                                </h3>
                                                <div class="product-price">
                                                    <div class="price">
                                                ...
                                                <div class="shipping-feed-back">
                                                    <div class="star-rating">
                                                        <div class="rating-wrap">
                                                            <p><i class="fas fa-star"></i><span>
                                                                    {{ number_format($item->ratings_avg_rating, 1) }}</span>
                                                            </p>
                                                        </div>
                                                        <div class="rating-counts-wrap">
    ...
    @if ($gs->is_report)
        @if (Auth::check())
            ...
            <div class="modal fade report" id="report-modal" tabindex="-1" role="dialog"
                            ...
                            <div class="login-area">
                                ...
                                <div class="login-form">
                                    ...
                                    <form id="reportform" action="{{ route('product.report') }}" method="POST">
                                        ...
                                        <div class="form-input">
                                            <textarea name="note" class="User Name form-control border" placeholder="{{ __('Enter Report Note') }}"
                                                required=""></textarea>
                                        </div>
